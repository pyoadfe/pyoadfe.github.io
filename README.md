...
### 22.04
Стохастические процессы с непрерывным временем. Теорема Винера-Хинчена о спектральной плотности мощности.
Оптимальная фильтрация на примере согласованного фильтра.

### 29.04
Проверка статистических гипотез. Ошибки I рода, и ошибки II рода. Лемма Неймана-Пирсона.

### 13.05
Проверка статистических гипотез. Распределение Стьюдента, распределение
Хи-квадрат Пирсона, тест Колмогорова-Смирнова, тесты многомерной нормальности и
инвариантность относительно афинных преообразований.
 ...
 * [Блокнот с деревом](https://github.com/pyoadfe/seminars/blob/master/decision_tree.py)
...
- [Учебник по программированию на Python](https://www.scaler.com/topics/python/) — Изучите интерактивное руководство по Python с примерами
